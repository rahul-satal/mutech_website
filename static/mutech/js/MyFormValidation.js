...
function validateForm() {
   return (isNotEmpty("fname", "Please enter your name!")
        && isNotEmpty("lname","Please enter your last name")
        && isNotEmpty("email","Please enter your father name")
        && isNotEmpty("phone","Please enter your Mother name")
        && isNotEmpty("message","Please enter your password")
        && isNumeric("ipcode", "Please enter a 5-digit zip code!")
        && isLengthMinMax("ipcode", "Please enter a 10-digit Mobile Number!", 10, 10)
